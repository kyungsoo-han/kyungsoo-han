...
업무 자동화, 재고관리 시스템, 현장 중심 업무 시스템 등 현실 문제를 해결하는 코드를 좋아합니다.  
기술을 단순히 쓰는 것에 그치지 않고, **"왜" 쓰는지, "어떻게" 동작하는지** 고민합니다.  
최근에는 **React, Tailwind CSS, shadcn/ui**를 활용한 프론트엔드 구조도 함께 경험하고 있으며,  
**LLM을 활용해 다양한 서비스와 기능을 직접 구현하고 실험**하고 있습니다.  
...
<img src="https://img.shields.io/badge/CI%2FCD-FC6D26?style=flat-square&logo=gitlab&logoColor=white"/>
...
<img src="https://img.shields.io/badge/AI%20Service%20Development-555555?style=flat-square"/>
